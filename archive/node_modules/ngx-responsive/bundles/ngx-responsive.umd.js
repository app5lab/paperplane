(function (global, factory) {
	typeof exports === 'object' && typeof module !== 'undefined' ? factory(exports, require('@angular/core'), require('rxjs/observable/fromEvent'), require('rxjs/operators/debounceTime'), require('rxjs/operators/defaultIfEmpty'), require('rxjs/operators/map'), require('rxjs/operators/startWith'), require('rxjs/ReplaySubject'), require('rxjs/operators')) :
	typeof define === 'function' && define.amd ? define('ngx-responsive', ['exports', '@angular/core', 'rxjs/observable/fromEvent', 'rxjs/operators/debounceTime', 'rxjs/operators/defaultIfEmpty', 'rxjs/operators/map', 'rxjs/operators/startWith', 'rxjs/ReplaySubject', 'rxjs/operators'], factory) :
	(factory((global['ngx-responsive'] = {}),global.ng.core,global.Rx.Observable,global.Rx.Observable.prototype,global.Rx.Observable.prototype,global.Rx.Observable.prototype,global.Rx.Observable.prototype,global.Rx,global.Rx.Observable.prototype));
}(this, (function (exports,core,fromEvent,debounceTime,defaultIfEmpty,map,startWith,ReplaySubject,operators) { 'use strict';
...
var ResponsiveState = /** @class */ (function () {
    function ResponsiveState(_responsiveConfig) {
        ...
        var _resize$ = fromEvent.fromEvent(this._window, 'resize')
            .pipe(debounceTime.debounceTime(this._responsiveConfig.config.debounceTime), defaultIfEmpty.defaultIfEmpty(), startWith.startWith(this.getWidth('window')));
        var _pixelRatio$ = fromEvent.fromEvent(this._window, 'onload')
            .pipe(defaultIfEmpty.defaultIfEmpty(), startWith.startWith(this.getDevicePixelRatio()));
        var _device$ = fromEvent.fromEvent(this._window, 'onload')
            .pipe(defaultIfEmpty.defaultIfEmpty(), startWith.startWith(this.getUserAgent()));
        var _userAgent$ = fromEvent.fromEvent(this._window, 'onload')
            .pipe(defaultIfEmpty.defaultIfEmpty(), startWith.startWith(this.userAgentData()));
        var _orientation$ = fromEvent.fromEvent(this._window, 'orientationchange')
            .pipe(defaultIfEmpty.defaultIfEmpty(), startWith.startWith(this.getOrientation()));
        this.elemento$ = _resize$.pipe(map.map(this.sizeOperations.bind(this)));
        this.ancho$ = _resize$.pipe(map.map(this.sizeObserver.bind(this)));
        this.browser$ = _device$.pipe(map.map(this.browserName.bind(this)));
        this.pixel$ = _pixelRatio$.pipe(map.map(this.pixelRatio.bind(this)));
        this.device$ = _device$.pipe(map.map(this.deviceDetection.bind(this)));
        this.orientation$ = _orientation$.pipe(map.map(this.orientationDevice.bind(this)));
        this.standard$ = _device$.pipe(map.map(this.standardDevices.bind(this)));
        this.ieVersion$ = _device$.pipe(map.map(this.ieVersionDetect.bind(this)));
        this.userAgent$ = _userAgent$.pipe(map.map(this.userAgentData.bind(this)));
    }
...
ShowItBootstrapDirective.propDecorators = {
    "showItBootstrap": [{ type: core.Input },],
};
...
HideItBootstrapDirective.propDecorators = {
    "hideItBootstrap": [{ type: core.Input },],
};
...
HideIEVersionDirective.propDecorators = {
    "hideIEVersion": [{ type: core.Input },],
};
var BrowserInfo = /** @class */ (function () {
    function BrowserInfo(_responsiveState) {
        this._responsiveState = _responsiveState;
        this.replaySubject$ = new ReplaySubject.ReplaySubject();
    }
...
BrowserInfoDirective.propDecorators = {
    "browser": [{ type: core.Output },],
    "browserInfo": [{ type: core.Input },],
};
...
IeInfoDirective.decorators = [
    { type: core.Directive, args: [{ selector: 'ie-info' },] },
];
...
IeInfoDirective.propDecorators = {
    "ieInfo": [{ type: core.Input },],
    "ieVersion": [{ type: core.Output },],
};
...
IsAndroidMobileDirective.propDecorators = {
    "isAndroidMobile": [{ type: core.Input },],
};
...
IsAndroidTabletDirective.propDecorators = {
    "isAndroidTablet": [{ type: core.Input },],
};
...
IsWindowsPhoneDirective.propDecorators = {
    "isWindowsPhone": [{ type: core.Input },],
};
...
ShowItStandardDirective.propDecorators = {
    "showItStandard": [{ type: core.Input },],
};
...
HideItStandardDirective.propDecorators = {
    "hideItStandard": [{ type: core.Input },],
};
...
DeviceInfoDirective.decorators = [
    { type: core.Directive, args: [{ selector: 'device-info' },] },
];
...
DeviceStandardInfoDirective.decorators = [
    { type: core.Directive, args: [{ selector: 'device-standard-info' },] },
];
...
DeviceStandardInfoDirective.propDecorators = {
    "deviceStandardInfo": [{ type: core.Input },],
    "standard": [{ type: core.Output },],
};
...
OrientationInfoDirective.decorators = [
    { type: core.Directive, args: [{ selector: 'orientation-info' },] },
];
...
PixelRatioInfoDirective.decorators = [
    { type: core.Directive, args: [{ selector: 'pixel-ratio-info' },] },
];
...
PixelRatioInfoDirective.propDecorators = {
    "pixelratioInfo": [{ type: core.Input },],
    "pixelratio": [{ type: core.Output },],
};
...
ResponsiveSizeInfoDirective.decorators = [
    { type: core.Directive, args: [{ selector: 'responsiveSizeInfo' },] },
];
...
ResponsiveSizeInfoDirective.propDecorators = {
    "responsiveSizeInfo": [{ type: core.Input },],
...
ResponsiveWindowDirective.propDecorators = {
    "name": [{ type: core.Input, args: ['responsive-window',] },],
};
